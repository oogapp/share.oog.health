...
export type Post = Node & {
  ...
  /** The current user's SparkyChat for this post, if it exists */
  sparkyChat?: Maybe<SparkyChat>;
...
export type ReflectionAnalysisScore = Node & {
  ...
  result?: Maybe<ReflectionAnalysisResult>;
...
export type ReflectionAnalysisScoreWhereInput = {
  ...
  /** result edge predicates */
  hasResult?: InputMaybe<Scalars['Boolean']['input']>;
  hasResultWith?: InputMaybe<Array<ReflectionAnalysisResultWhereInput>>;
  /** id field predicates */
  id?: InputMaybe<Scalars['ID']['input']>;
  idGT?: InputMaybe<Scalars['ID']['input']>;
  idGTE?: InputMaybe<Scalars['ID']['input']>;
